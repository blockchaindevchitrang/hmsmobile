  ...
  const renderItem = ({item, index}) => {
    return (
      <View
        ...
        <View
          style={[styles.nameDataView, {width: isPortrait ? wp(35) : wp(31)}]}>
          <Text style={[styles.dataHistoryText2]}>{item.title}</Text>
        </View>
        <View
          style={[styles.switchView, {width: isPortrait ? wp(35) : wp(31)}]}>
              ...
              <View>
                <View
                  ...
                  <Text
                    style={[
                      styles.titleText,
                      {width: isPortrait ? wp(35) : wp(31), textAlign: 'left'},
                    ]}>
                    {'FILE NAME'}
                  </Text>
                  <Text
                  ...
                  <Text
                    style={[
                      styles.titleText,
                      {
                        width: isPortrait ? wp(16) : wp(15.1),
                        textAlign: 'center',
                      },
                    ]}>
                    {documentAction.includes('edit') ||
          ...
          <View style={styles.container}>
            ...
            {isPortrait ? (
              ...
              <View style={styles.profileView}>
                ...
                <View style={styles.nameView}>
                  <View style={{width: '20%'}}>
                    <Text style={styles.dataHistoryText1}>Attachment</Text>
                    <View style={styles.profilePhotoView}>
                      <TouchableOpacity
                        style={styles.editView}
                        onPress={() => openProfileImagePicker()}>
