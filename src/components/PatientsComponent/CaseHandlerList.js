  ...
  const renderItem = ({item, index}) => {
    return (
      <View
        ...
        <View
          style={[styles.switchView, {width: isPortrait ? wp(32) : wp(23)}]}>
      ...
      {!newUserVisible ? (
        ...
        <ScrollView
          ...
          <View style={styles.profileView}>
            ...
            <View style={styles.nameView}>
              <View style={{width: '48%'}}>
                <Text style={styles.dataHistoryText6}>DESIGNATION:</Text>
                <TextInput
                  value={designation}
                  placeholder={''}
              ...
              <View style={{width: '48%'}}>
                <Text style={styles.dataHistoryText6}>PHONE NUMBER</Text>
                <TextInput
                  value={number}
            ...
            <View style={styles.nameView}>
              <View style={{width: '48%'}}>
                <Text style={styles.dataHistoryText6}>QUALIFICATION:</Text>
                <TextInput
                  value={qualification}
                  placeholder={''}
            ...
            {isPortrait ? (
              <View style={styles.nameView}>
                <View style={{width: '100%'}}>
                  <Text style={styles.dataHistoryText6}>ADDRESS 1</Text>
                  <TextInput
                    value={address}
              ...
              <View style={styles.nameView}>
                ...
                <View style={{width: '48%'}}>
                  <Text style={styles.dataHistoryText6}>ADDRESS 2</Text>
                  <TextInput
                    value={address1}
            ...
            <View style={styles.nameView}>
              <View style={{width: '48%'}}>
                <Text style={styles.dataHistoryText6}>BLOOD GROUP:</Text>
                {/* <TextInput
                  value={bloodGroup}
                  placeholder={'Select'}
            ...
            <View style={styles.nameView}>
              ...
              <View style={{width: '48%'}}>
                <Text style={styles.dataHistoryText6}>ZIP</Text>
                <TextInput
                  value={postalCode}
                  placeholder={'Zip'}
