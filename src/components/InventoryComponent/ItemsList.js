  ...
  const renderItem = ({item, index}) => {
    return (
      <View
        ...
        <View
          style={[styles.switchView, {width: isPortrait ? wp(35) : wp(29)}]}>
          <Text style={[styles.dataHistoryText1]}>{item.itemcategory}</Text>
        </View>
        <View
          style={[styles.switchView, {width: isPortrait ? wp(22) : wp(16)}]}>
              ...
              <View>
                <View
                  ...
                  <Text
                    style={[
                      styles.titleText,
                      {width: isPortrait ? wp(35) : wp(27), textAlign: 'left'},
                    ]}>
                    {'NAME'}
                  </Text>
                  <Text
