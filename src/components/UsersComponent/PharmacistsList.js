...
const PharmacistsList = ({searchBreak, setSearchBreak, allData, onGetData}) => {
  ...
  const onAddUsers = async () => {
    try {
      ...
      formdata.append('department_id', '6');
              ...
              <Menu
                ...
                <MenuOptions style={{marginVertical: hp(0.5)}}>
                  <MenuOption value={'add'}>
                    <Text style={styles.dataHistoryText3}>New Pharmacists</Text>
                  </MenuOption>
