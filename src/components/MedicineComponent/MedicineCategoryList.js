        ...
        <View style={styles.maneModalView}>
          ...
          <View style={styles.container}>
            <View style={styles.headerView}>
              <Text style={styles.headerText}>New Medicines Category</Text>
            ...
            />
            <View style={[styles.actionDataView1]}>
              <Text style={[styles.titleText1, {marginHorizontal: wp(2)}]}>
                {'Status:'}
              </Text>
